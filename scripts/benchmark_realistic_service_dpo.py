#!/usr/bin/env python3
"""
Run the realistic-service benchmark suite for Phase 4 v2.
"""
...
DEFAULT_DPO_MODEL = "outputs/preference_first_dpo_qwen25_3b_v2_realistic_service/dpo_model_v1"
DEFAULT_JUDGE_MODEL = "/data/wtw/Desktop/resume/models/Qwen2.5-7B-Instruct"
DEFAULT_OUTPUT = "outputs/preference_first_dpo_qwen25_3b_v2_realistic_service/benchmark_realistic_service.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Benchmark the realistic-service DPO suite.")
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Whether to enable the stronger pairwise judge pass",
    )
    parser.add_argument(
        "--inference-use-4bit",
        action=argparse.BooleanOptionalAction,
    ...
    parser.add_argument("--judge-weight", type=float, default=0.8, help="LLM judge weight")
    ...
    benchmark = Benchmark(
        ...
        use_pairwise_judge=args.use_pairwise_judge,
        ...
        benchmark_profile="realistic_service",
